                    ...
                    <div class="col-sm-4">
                        <div class="product">
                            <div class="product-img" id="product-img">
                               <a href="addAuthor_book.php?id=${data['id_book']}"><img src="img/scale_1200.webp" alt=""></a>
                            </div>
                            <p class="product-title" id="product-title">${nameBook}</p>
                            <p class="product-desc" id="product-desc">${fio}</p>   
                             <a href="refactor.php?id=${data['id_book']}">Изменить</a>  
